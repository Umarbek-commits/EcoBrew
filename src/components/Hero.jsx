...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden bg-eco-dark grain">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] rounded-full bg-eco-main/20 translate-x-1/3 -translate-y-1/3 blur-3xl" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-eco-light/10 -translate-x-1/3 translate-y-1/3 blur-3xl" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-4xl">
          ...
          {/* Main heading */}
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-8xl font-black text-white leading-[0.95] mb-6">
            Eco
            <span className="text-eco-light italic">Brew</span>
          </h1>

          {/* Slogan */}
          <p className="font-heading text-xl sm:text-2xl lg:text-3xl text-eco-cream font-normal italic mb-4 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#about" className="inline-flex items-center justify-center gap-2 bg-eco-light text-eco-dark font-body font-bold px-8 py-4 rounded-full text-lg hover:bg-white transition-all duration-200 shadow-xl hover:shadow-eco-light/40 hover:-translate-y-1">
              <FaLeaf />
              О проекте
            </a>
