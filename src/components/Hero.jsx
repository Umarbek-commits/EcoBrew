...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center overflow-x-hidden overflow-y-hidden bg-eco-dark grain"
    >
      {/* Background decorative circles */}
      <div className="absolute top-0 right-0 w-[250px] h-[250px] md:w-[600px] md:h-[600px] rounded-full bg-eco-main/20 translate-x-1/3 -translate-y-1/3 blur-xl" />
      
      <div className="absolute bottom-0 left-0 w-[200px] h-[200px] md:w-[400px] md:h-[400px] rounded-full bg-eco-light/10 -translate-x-1/3 translate-y-1/3 blur-xl" />
      
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] md:w-[800px] md:h-[800px] rounded-full border border-white/5" />
      
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250px] h-[250px] md:w-[600px] md:h-[600px] rounded-full border border-white/5" />

      {/* Falling coffee grounds particles */}
      {[...Array(40)].map((_, i) => (
        <div
          key={i}
          ...
          style={{
            ...
            top: '-20px',
            animation: `coffeeFall ${4 + Math.random() * 3}s linear forwards`,
